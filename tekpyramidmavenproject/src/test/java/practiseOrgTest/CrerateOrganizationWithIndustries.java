...
public class CrerateOrganizationWithIndustries {
	...
	WebElement industrDropdown=driver.findElement(By.xpath("//select[@name='industry']"));
	Select sel = new Select(industrDropdown);
	
	sel.selectByVisibleText("Energy");
	WebElement pressDropdown=driver.findElement(By.name("accounttype"));
	Select sele = new Select(pressDropdown);
	sele.selectByVisibleText("Press");
